...
const PhilosphyListWithus = ({ listWithUs }) => {
                                                                                        ...
                                                                                        <div className="col-lg-12 align-self-center">
                                                                                                <div className="slide-item-info">
                                                                                                        <div className="slide-item-info-inner ltn__slide-animation">
                                                                                                                ...
                                                                                                                <h1 className="slide-title animated "> <br /><span>{item?.sec7_h}  </span></h1>
...
export default PhilosphyListWithus