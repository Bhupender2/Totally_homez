...
const CommunityGrid2 = () => {
    ...
    return (
        <div className="ltn__product-slider-area ltn__product-gutter pt-40 pb-40 plr--12">
                            ...
                            <div className="col-lg-4">
                                <div key={categoryProperty?.id} className="ltn__product-item ltn__product-item-4 text-center---">
                                    <div className="product-img go-top">
                                        <Link to={`/property-details/${categoryProperty?.id}`}><img src={`https://www.dayofdubai.com/sites/default/files/news/dubais-most-luxurious-and-exclusive-penthouses-and-apartments-13006.jpg`} alt="#" /></Link>
                ...
                <div className="row ltn__product-slider-item-three-active-full-width slick-arrow-1">
                    {
                        townhouseCategoryRentProperties?.map((categoryProperty) => (
                            <div className="col-lg-4">
                                <div key={categoryProperty?.id} className="ltn__product-item ltn__product-item-4 text-center---">
                                    <div className="product-img go-top">
                                        <Link to={`/property-details/${categoryProperty?.id}`}><img src={`https://www.christiesrealestate.com/blog/wp-content/uploads/2022/12/luxury-penthouse-office-dubai.jpg?is-pending-load=1`} alt="#" /></Link>
                                        <div className="product-badge">
                                            <ul>
                                                <li className="sale-badge bg-green">{categoryProperty?.property_for}</li>
                                            </ul>
                ...
                <div className="row ltn__product-slider-item-three-active-full-width slick-arrow-1">
                    {
                        townhouseCategoryRentProperties?.map((categoryProperty) => (
                            <div className="col-lg-4">
                                <div key={categoryProperty?.id} className="ltn__product-item ltn__product-item-4 text-center---">
                                    <div className="product-img go-top">
                                        <Link to={`/property-details/${categoryProperty?.id}`}><img src={`https://imagedelivery.net/cyTHrsLOsnLPkuSeNd2_9g/a2d20da9-ecee-49d0-cea7-8a18efe6fe00/public?%20%20%20%20.jpg`} alt="#" /></Link>
                                        <div className="product-badge">
                                            <ul>
                                                <li className="sale-badge bg-green">{categoryProperty?.property_for}</li>
                                            </ul>
