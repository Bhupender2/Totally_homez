...
let carouselItems = [
    { id: 1, content: 'https://d34mfkth6cubud.cloudfront.net/wp-content/uploads/2022/08/23093844/Why-Invest-in-Off-Plan-Property-in-Dubai-_-Body-4-18-8-22-1-1024x640.jpg' },
                ...
                <div className="col-lg-12 ">
                    <div key={item?.id} className="ltn__product-item ltn__product-item-4 text-center---">
                        <div className="product-img go-top">
                            <img className='carouselImages' src={`https://d34mfkth6cubud.cloudfront.net/wp-content/uploads/2022/08/23093844/Why-Invest-in-Off-Plan-Property-in-Dubai-_-Body-4-18-8-22-1-1024x640.jpg`} alt="#" />
